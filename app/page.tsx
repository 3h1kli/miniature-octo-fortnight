...
export default function GrowGardenRewards() {
  ...
  const gardenItems = [
    { id: 1, name: "Red Fox", image: "https://static.wikia.nocookie.net/growagarden/images/d/d5/RedFox.png" },
    { id: 2, name: "T-Rex", image: "https://static.wikia.nocookie.net/growagarden/images/f/f8/T-Rex.png" },
    { id: 3, name: "Fennec Fox", image: "https://static.wikia.nocookie.net/growagarden/images/e/e8/FennecFoxIcon.png" },
    { id: 4, name: "Bald Eagle", image: "https://static.wikia.nocookie.net/growagarden/images/d/d2/BaldEagle.png" },
    {
      id: 5,
      name: "Red Dragon",
      image: "https://static.wikia.nocookie.net/growagarden/images/6/6e/RedDragonRender.png",
    },
    { id: 6, name: "x10 Candy Blossom", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/6_candy_blossom.png" },
    { id: 7, name: "Kiwi", image: "https://static.wikia.nocookie.net/growagarden/images/e/ea/Kiwi.png" },
    { id: 8, name: "Hedgehog Pet", image: "https://static.wikia.nocookie.net/growagarden/images/4/46/HedgehogPet.png" },
    { id: 9, name: "Blood Owl", image: "https://static.wikia.nocookie.net/growagarden/images/0/00/Blood_Owl_Icon.png" },
    {
      id: 10,
      name: "Raccoon",
      image: "https://static.wikia.nocookie.net/growagarden/images/5/54/Raccon_Better_Quality.png",
    },
    { id: 11, name: "282T¢(seckles)", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/Plants1.png" },
    { id: 12, name: "Night Owl", image: "https://static.wikia.nocookie.net/growagarden/images/3/3e/NightOwlPic.png" },
    { id: 13, name: "Hamster", image: "https://static.wikia.nocookie.net/growagarden/images/c/c5/HamsterIcon.webp" },
    {
      id: 14,
      name: "Chicken Zombie",
      image: "https://static.wikia.nocookie.net/growagarden/images/b/be/Chicken_Zombie_Icon.png",
    },
    { id: 15, name: "Firefly", image: "https://static.wikia.nocookie.net/growagarden/images/c/cd/Again.png" },
    { id: 16, name: "Owl", image: "https://static.wikia.nocookie.net/growagarden/images/4/46/Owlpng.png" },
    { id: 17, name: "Golden Bee", image: "https://static.wikia.nocookie.net/growagarden/images/e/e8/GoldenBee.png" },
    { id: 18, name: "Echo Frog", image: "https://static.wikia.nocookie.net/growagarden/images/3/30/Echo_frog.png" },
    { id: 19, name: "Cooked Owl", image: "https://static.wikia.nocookie.net/growagarden/images/f/fc/Cooked_Owl.png" },
    { id: 20, name: "Cow", image: "https://static.wikia.nocookie.net/growagarden/images/8/84/Cow.png" },
    { id: 21, name: "Polar Bear", image: "https://static.wikia.nocookie.net/growagarden/images/2/25/Polarbear.png" },
    { id: 22, name: "Sea Otter", image: "https://static.wikia.nocookie.net/growagarden/images/c/c3/Sea_Otter.png" },
    {
      id: 23,
      name: "Silver Monkey",
      image: "https://static.wikia.nocookie.net/growagarden/images/a/a7/Silvermonkey.png",
    },
    { id: 24, name: "Mushroom", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/mushroom%20(1).webp" },
    { id: 25, name: "Grape", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/grape%20(1).webp" },
    { id: 26, name: "Friendship Pot", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/Friendship_Pot.webp" },
    { id: 27, name: "Ember Lily", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/ember.webp" },
    { id: 28, name: "Disco Bee", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/disco.webp" },
    { id: 29, name: "Butterfly Pet", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/butterfly.webp" },
    { id: 30, name: "Mango", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/mango.webp" },
    { id: 31, name: "Dragonfruit", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/dragonfruit.webp" },
    { id: 32, name: "Cactus", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/cactus.webp" },
    { id: 33, name: "Coconut", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/coconut.webp" },
    { id: 34, name: "Bamboo", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/bamboo.webp" },
    { id: 35, name: "Apple", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/apple.webp" },
    { id: 36, name: "Pumpkin", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/pumpkin.webp" },
    { id: 37, name: "Watermelon", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/watermelon.webp" },
    { id: 38, name: "Daffodil", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/daffodil.webp" },
    { id: 39, name: "Corn", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/corn.webp" },
    { id: 40, name: "Tomato", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/tomato.webp" },
    { id: 41, name: "Orange", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/orange.webp" },
    { id: 42, name: "Blueberry", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/blueberry.webp" },
    { id: 43, name: "Carrot", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/carrot.webp" },
    { id: 44, name: "Flower Pack", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/flowerpack.webp" },
    { id: 45, name: "Beanstalk", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/beanstalk.png" },
    { id: 46, name: "Strawberry", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/Strawberry.webp" },
    { id: 47, name: "Super Seed", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/Super_Seed.webp" },
  ]
