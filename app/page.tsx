...
export default function GrowGardenRewards() {
  ...
  const gardenItems = [
    ...
    { id: 4, name: "Red Fox", image: "https://static.wikia.nocookie.net/growagarden/images/d/d5/RedFox.png" },
    { id: 5, name: "T-Rex", image: "https://static.wikia.nocookie.net/growagarden/images/f/f8/T-Rex.png" },
    { id: 6, name: "Fennec Fox", image: "https://static.wikia.nocookie.net/growagarden/images/e/e8/FennecFoxIcon.png" },
    { id: 7, name: "Bald Eagle", image: "https://static.wikia.nocookie.net/growagarden/images/d/d2/BaldEagle.png" },
    {
      id: 8,
      name: "Red Dragon",
      image: "https://static.wikia.nocookie.net/growagarden/images/6/6e/RedDragonRender.png",
    },
    { id: 9, name: "Spinosaurus", image: "https://static.wikia.nocookie.net/growagarden/images/2/24/Spinosaurus.png" },
    { id: 10, name: "Dragonfly", image: "https://static.wikia.nocookie.net/growagarden/images/c/c9/DragonflyIcon.png" },
    { id: 11, name: "Queen Bee", image: "https://static.wikia.nocookie.net/growagarden/images/7/7a/Queen_bee.png" },
    { id: 12, name: "Blood Owl", image: "https://static.wikia.nocookie.net/growagarden/images/0/00/Blood_Owl_Icon.png" },
    {
      id: 13,
      name: "kiwi",
      image: "https://static.wikia.nocookie.net/growagarden/images/e/ea/Kiwi.png",
    },
    { id: 14, name: "x10 Candy Blossom", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/6_candy_blossom.png" },
    { id: 15, name: "Raccoon", image: "https://static.wikia.nocookie.net/growagarden/images/5/54/Raccon_Better_Quality.png" },
    { id: 16, name: "Hedgehog Pet", image: "https://static.wikia.nocookie.net/growagarden/images/4/46/HedgehogPet.png" },
    { id: 17, name: "282T¢(seckles)", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/Plants1.png" },
    { id: 18, name: "Night Owl", image: "https://static.wikia.nocookie.net/growagarden/images/3/3e/NightOwlPic.png" },
    { id: 19, name: "Hamster", image: "https://static.wikia.nocookie.net/growagarden/images/c/c5/HamsterIcon.webp" },
    {
      id: 20,
      name: "Chicken Zombie",
      image: "https://static.wikia.nocookie.net/growagarden/images/b/be/Chicken_Zombie_Icon.png",
    },
    { id: 21, name: "Firefly", image: "https://static.wikia.nocookie.net/growagarden/images/c/cd/Again.png" },
    { id: 22, name: "Owl", image: "https://static.wikia.nocookie.net/growagarden/images/4/46/Owlpng.png" },
    { id: 23, name: "Golden Bee", image: "https://static.wikia.nocookie.net/growagarden/images/e/e8/GoldenBee.png" },
    { id: 24, name: "Echo Frog", image: "https://static.wikia.nocookie.net/growagarden/images/3/30/Echo_frog.png" },
    { id: 25, name: "Cooked Owl", image: "https://static.wikia.nocookie.net/growagarden/images/f/fc/Cooked_Owl.png" },
    { id: 26, name: "Cow", image: "https://static.wikia.nocookie.net/growagarden/images/8/84/Cow.png" },
    { id: 27, name: "Polar Bear", image: "https://static.wikia.nocookie.net/growagarden/images/2/25/Polarbear.png" },
    { id: 28, name: "Sea Otter", image: "https://static.wikia.nocookie.net/growagarden/images/c/c3/Sea_Otter.png" },
    {
      id: 29,
      name: "Silver Monkey",
      image: "https://static.wikia.nocookie.net/growagarden/images/a/a7/Silvermonkey.png",
    },
    { id: 30, name: "Mushroom", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/mushroom%20(1).webp" },
    { id: 31, name: "Grape", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/grape%20(1).webp" },
    { id: 32, name: "Friendship Pot", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/Friendship_Pot.webp" },
    { id: 33, name: "Ember Lily", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/ember.webp" },
    { id: 34, name: "Disco Bee", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/disco.webp" },
    { id: 35, name: "Butterfly Pet", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/butterfly.webp" },
    { id: 36, name: "Mango", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/mango.webp" },
    { id: 37, name: "Dragonfruit", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/dragonfruit.webp" },
    { id: 38, name: "Cactus", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/cactus.webp" },
    { id: 39, name: "Coconut", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/coconut.webp" },
    { id: 40, name: "Bamboo", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/bamboo.webp" },
    { id: 41, name: "Apple", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/apple.webp" },
    { id: 42, name: "Pumpkin", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/pumpkin.webp" },
    { id: 43, name: "Watermelon", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/watermelon.webp" },
    { id: 44, name: "Daffodil", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/daffodil.webp" },
    { id: 45, name: "Corn", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/corn.webp" },
    { id: 46, name: "Tomato", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/tomato.webp" },
    { id: 47, name: "Orange", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/orange.webp" },
    { id: 48, name: "Blueberry", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/blueberry.webp" },
    { id: 49, name: "Carrot", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/carrot.webp" },
    { id: 50, name: "Flower Pack", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/flowerpack.webp" },
    { id: 51, name: "Beanstalk", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/beanstalk.png" },
    { id: 52, name: "Strawberry", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/Strawberry.webp" },
    { id: 53, name: "Super Seed", image: "https://cdn.jsdelivr.net/gh/monorolls/grow@main/Super_Seed.webp" },
    { id: 54, name: "Moon Blossom", image: "https://static.wikia.nocookie.net/growagarden/images/7/77/MoonBlossomBetterQuality.png" },
  ]
